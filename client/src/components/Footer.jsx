        ...
        <div className="w-full max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                    <div>
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://www.linkedin.com/in/isha-gupta-b89a77258' target='_blank' rel='noopener noreferrer'>
                                Isha Gupta
                            </Footer.Link>
                    ...
                    <div>
                        <Footer.Title title='Follow'/>
                            <Footer.LinkGroup col>
                                <Footer.Link href='https://github.com/IshaGuptaa/IshaGuptaa' target='_blank' rel='noopener noreferrer'>
                                    GitHub
                                </Footer.Link>
                                <Footer.Link href='#' target='_blank' rel='noopener noreferrer'>
                                    Discord
            ...
            <div className="w-full sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
                    ...
                    <Footer.Icon target='_blank' href='https://www.github.com/asyedibrahihttps://github.com/IshaGuptaa/IshaGuptaa' icon={BsGithub}/>
